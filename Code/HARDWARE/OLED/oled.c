...
//OLED的初始化
void OLED_Init(void)//A12 SCL D5 SDA
{
...
void OLED_ShowTarget(u8 x,u8 y)
{
	OLED_DrawPoint(x-2,y-2,1);
...
void OLED_RemoveTarget(u8 x,u8 y)
{
	OLED_DrawPoint(x-2,y-2,0);
	OLED_DrawPoint(x-2,y-1,0);
	OLED_DrawPoint(x-2,y,0);
	OLED_DrawPoint(x-2,y+1,0);
	OLED_DrawPoint(x-2,y+2,0);
	...
	OLED_DrawPoint(x-2,y-2,0);
	OLED_DrawPoint(x-1,y-2,0);
	OLED_DrawPoint(x,y-2,0);
	OLED_DrawPoint(x+1,y-2,0);
	OLED_DrawPoint(x+2,y-2,0);
